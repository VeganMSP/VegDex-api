...
router.register("link-categories", links_views.LinkCategoryViewSet, "link-categories")
router.register("links-by-category", links_views.LinksByCategoryViewSet, "links-by-category")
