...
namespace VegDex.Infrastructure.Migrations
{
    ...
    [Migration("20230719180734_AddUserEntity")]
            ...
            modelBuilder.Entity("VegDex.Core.Entities.AboutPage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 7, 19, 13, 7, 33, 484, DateTimeKind.Local).AddTicks(3410),
                            DateUpdated = new DateTime(2023, 7, 19, 13, 7, 33, 484, DateTimeKind.Local).AddTicks(3480)
                        });
                });
            ...
            modelBuilder.Entity("VegDex.Core.Entities.HomePage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 7, 19, 13, 7, 33, 482, DateTimeKind.Local).AddTicks(8720),
                            DateUpdated = new DateTime(2023, 7, 19, 13, 7, 33, 482, DateTimeKind.Local).AddTicks(8810)
                        });
                });
